...
;;;; internal faces
    ...
    `(standard-themes-mark-other ((,c :inherit warning :background ,bg-warning)))
...
;;;; diff-mode
    ...
    `(diff-refine-added ((,c :background ,bg-added-refine :foreground ,fg-main)))
    `(diff-refine-changed ((,c :background ,bg-changed-refine :foreground ,fg-main)))
    `(diff-refine-removed ((,c :background ,bg-removed-refine :foreground ,fg-main)))
...
;;;; magit
    ...
    `(magit-diff-hunk-heading-highlight ((,c :inherit bold :background ,bg-active :foreground ,fg-main)))
    `(magit-diff-hunk-heading-selection ((,c :inherit bold :background ,bg-hover-alt :foreground ,fg-main)))
